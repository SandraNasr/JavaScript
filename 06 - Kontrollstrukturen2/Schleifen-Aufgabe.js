...
for (let i = 0; i < 25; i++)
{
    console.log(i, "Ich soll im Unterricht aufpassen")
}
...
let startSecondList = Math.floor(length / 2)
...
{
  sumStudents += course.length
}

console.log("Teilnehmer im Kurs:", sumStudents)
