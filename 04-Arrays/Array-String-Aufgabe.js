...
console.log("Erika: " + studentsList.indexOf("Erika"))

let eIndex = studentsList.indexOf("Erika")

studentsList.splice(eIndex, 1)
console.log(studentsList)
...
// 
let studentsList2 = students.split(", ")
console.log(studentsList2)

students = studentsList2.join("\n- ")
console.log("- " + students)
console.log("-".repeat(20))
