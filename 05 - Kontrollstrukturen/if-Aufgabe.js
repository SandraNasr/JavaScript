...
if (students1.indexOf(student)> 0 || students2.indexOf(student)> 0)
{
...
// Schreibe deinen Code hier
let studentCancel = "Veronika"
let indexStudentCancel = null

if (students1.indexOf(studentCancel) >= 0)
{
    indexStudentCancel = students1.indexOf(studentCancel)
    students1.splice(indexStudentCancel, 1)
    console.log(studentCancel + " wurde aus der Liste 1 entfernt.")
    console.log(students1)
}
else if (students2.indexOf(studentCancel) >= 0)
{
    indexStudentCancel = students2.indexOf(studentCancel)
    students2.splice(indexStudentCancel, 1)
    console.log(studentCancel + " wurde aus der Liste 2 entfernt.")
    console.log(students2)
}
else
{
    console.log(studentCancel + " ist in keiner Liste.")
}
...
if (numberOfStudents === 1)
 {
    amountHour = 40
    console.log("Die Stunde kostet " + amountHour + " €.")
 }
 else if (numberOfStudents<=5 && numberOfStudents >=2)
 {
    amountHour = 25
    console.log("Die Stunde kostet " + amountHour + " €.")
 }
